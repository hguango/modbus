...
class TcpQuery(Query):
    ...
    def _get_transaction_id(self):
        ...
        #print TcpQuery._last_transaction_id
...
class TcpServer(Server):
    ...
    def _do_init(self):
        ...
        self._sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)  # Added by zhen.zhang on 2015-09-23
